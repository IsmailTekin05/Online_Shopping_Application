...
public class RegisterCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField7.setText("Referrer ID");
    ...
    String heightStr = jTextField4.getText();
    String password = jTextField5.getText();
    String ageStr = jTextField6.getText();
    String referrerIdStr = jTextField7.getText();

    AuthService authService = new AuthService();

    // Call the insertCustomer method that takes all strings
    int newCustomerId = authService.insertCustomer(name, phone, email, password, heightStr, ageStr, referrerIdStr);
    ...
    if (newCustomerId != -1) {
        ...
        // Open LoginPage and close current window
